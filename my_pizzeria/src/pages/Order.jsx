...
export default function Order({ setCounter }) {
    ...
    return (
        <div className={styles.container}>
            ...
            <form onSubmit={(e) => {
                ...
                <button type='submit' className={styles.orderBtn} title='order now!' onClick={() => { setIsOpen(true); setCounter(null) }}><BiMailSend /></button>
            </form>
