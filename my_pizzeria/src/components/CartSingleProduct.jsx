...
? saucesArray.map((sauce, k) => {
    ...
    return (
        <tr key={i} className={styles.tr}>
            ...
            <td><button title='Delete' className={styles.deleteBtn} onClick={() => { Swal.fire("Deleted from cart!"); deleteProductFromCart({ id: product.id }); newCart.splice(i, 1); setCart(newCart); setCounter(counter - 1) }}><GiTrashCan /></button></td>
        </tr>
    )
}
